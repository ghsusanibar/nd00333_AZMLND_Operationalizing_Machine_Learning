...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer ysJcezaHr3RLtM82w3ItEHLMb3n1qoZo' http://9c2ec016-7734-4e9f-8e86-04cbb9f3648f.westus.azurecontainer.io/score
